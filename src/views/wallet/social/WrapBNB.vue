    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-1 mt-5">
        ...
        <div class="flex justify-end text-grey-normal text-sm">
          {{ $t('balance') }}: {{ formatAmount(isWrap ? accStore.ethBalance : accStore.wethBalance) }} {{ isWrap ? 'BNB' : 'WBNB' }}
        </div>
      </div>
      ...
      <div class="flex flex-col gap-1">
        ...
        <div class="flex justify-end text-grey-normal text-sm">
          {{ $t('balance') }}: {{ formatAmount(isWrap ? accStore.wethBalance : accStore.ethBalance) }} {{ isWrap ? 'WBNB' : 'BNB' }}
        </div>
      </div>
