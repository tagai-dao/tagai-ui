<script setup lang="ts">
    ...
    import { getPredictBattleData, getUserJoinedMarkets } from '@/apis/api'
    ...
    <template>
      <div class="predict-battle-container rounded-t-2xl overflow-hidden">
        ...
        >
          ...
          <PredictBattleCard v-else :battle="battle" :tweets="tweets" :showCommunity="true" v-for="battle in battles" :key="battle.predictAID + battle.predictBID" />
          </van-list>
        </van-pull-refresh>
      </div>
    </template>
