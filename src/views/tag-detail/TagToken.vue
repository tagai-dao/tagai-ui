...
import { PumpContract1, PumpContract2, PumpContract3 } from "@/config";
    ...
    >
      ...
      <div class="grid grid-cols-5 gap-x-2 h-8 items-center text-h4"
          ...
          <div class="col-span-3 truncate flex items-center gap-1">
            ...
            <span v-show="holder.ethAddr == PumpContract1 || holder.ethAddr == PumpContract2 || holder.ethAddr == PumpContract3" class="text-xs bg-purple-c1 text-blue-active px-1.5 rounded-full">Social Distribution</span>
          </div>
