...
<template>
  <div class="relative h-14 native-safe-bottom bg-surface">
    <div class="w-full h-full native-safe-tabbar-content flex justify-between items-center px-6 relative z-10">
